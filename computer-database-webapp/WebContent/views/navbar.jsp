	...
	<div id="navMenu" class="container">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
    		<div class="navbar-brand navbar-right dropdown">
		        ...
		        <a class="dropdown-item navItem" href="logout"><i id="logoutIcon" class="fas fa-sign-out-alt"></i><spring:message code="lbl.logout"></spring:message></a>
		        <a class="dropdown-item navItem" href="listComputers?startIndex=0&endIndex=10&search=&sorted=&lang=en"><img alt="englishLog" src="static/images/britainFlags.png"><spring:message code="lbl.english"></spring:message></a>
				<a class="dropdown-item navItem" href="listComputers?startIndex=0&endIndex=10&search=&sorted=&lang=fr"><img alt="frenchLog" src="static/images/frenchFlags.png"><spring:message code="lbl.french"></spring:message></a>
		      </div>
			</div>
		</div>
	</div>
