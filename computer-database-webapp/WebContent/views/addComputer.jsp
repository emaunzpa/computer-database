		...
		<div class="container">
			<div class="row">
				<div class="col-xs-8 col-xs-offset-2 box">
					<h1>
						<spring:message code="lbl.addComputer" />
					</h1>
					<form:form id="computerForm" action="addComputer" method="POST"
						...
						<fieldset>
							<div class="form-group">
								...
								<form:input type="text" class="form-control" id="computerName"
									path="name" required="required" placeholder="${placeholder}" />
							...
							<div class="form-group">
								...
								<form:input type="date" class="form-control" id="introduced"
									path="introducedDate" placeholder="${placeholder}" />
							...
							<div class="form-group">
								...
								<form:input type="date" class="form-control" id="discontinued"
									path="discontinuedDate" placeholder="${placeholder}" />
